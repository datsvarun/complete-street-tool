...
## Project rules
- App code lives in /app (Vite + React + TS). Docs stay at root.
- All geometry in local metric CRS, lat/lon only at map boundary.
- One phase-slice per session. Stop at the done-when criteria and report.
